...
class RepDetector:
	...
	def __init__(self, proFrame, st_number):
		...
		self.frame_set = numpy.zeros([20,160,120])
		for i in range(20):
	...
	def get_boundingbox(self):
		...
		frameROIRes = numpy.zeros([20,50,50])
		for i in range(20):
			frameROIRes[i,:,:]=cv2.resize(framesRoi[i,:,:],(50,50),interpolation=cv2.INTER_NEAREST)
...
if __name__ == '__main__':
	...
	video_writer = cv2.VideoWriter("live_out.avi", fourcc, frame_rate, (1280, 720))
